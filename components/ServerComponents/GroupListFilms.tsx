...
const GroupListFilms:React.FC<GroupListFilmsProps> = async({title , type , movieListType}) => {
    const data = await getMovieListsByType( type, movieListType );

    return (
        <div className='group/newGroup  mt-2 '>
